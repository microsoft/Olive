...
```{Note}
Please refer to [this `user_script.py`](https://github.com/microsoft/Olive/blob/main/examples/bert/user_script.py) for a detailed example of how to set up a custom metric.
```
