...
ready for the production. The Olive Passes are design to receive an input model that is the output
...
Olive receives PyTorch or ONNX model as input. Olive can produce PyTorch or ONNX or hardware
