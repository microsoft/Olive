...
def common_test_rotate(rotate_pass, tmp_path, model_path, rotate_mode, atol):
    ...
    p = create_pass_from_dict(rotate_pass, {"rotate_mode": rotate_mode}, disable_search=True)
...
def test_spinquant(_, tmp_path, model_path, rotate_mode):
    ...
    common_test_rotate(SpinQuant, tmp_path, model_path, rotate_mode, 5e-3)
