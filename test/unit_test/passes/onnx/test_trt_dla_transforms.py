...
from olive.passes.onnx.tensorrt.trt_dla_transforms import TensorRTMatMulToConvTransform
...
def test_matmul_to_conv_transform(tmp_path):
    ...
    p = create_pass_from_dict(TensorRTMatMulToConvTransform, {}, disable_search=True)
