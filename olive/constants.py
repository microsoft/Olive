...
SETUP_REQUIREMENTS_CONVERSION = {
    "tensorflow_1.11": ["tensorflow==1.11.0", "pandas==1.4.2", "onnx=={}".format(ONNX_VERSION), "tf2onnx==1.9.3"],
    "tensorflow_1.12": ["tensorflow==1.12.0", "pandas==1.4.2", "onnx=={}".format(ONNX_VERSION), "tf2onnx==1.9.3"],
    "tensorflow_1.13": ["tensorflow==1.13.1", "pandas==1.4.2", "onnx=={}".format(ONNX_VERSION), "tf2onnx==1.9.3"],
    "tensorflow_1.14": ["tensorflow==1.14.0", "pandas==1.4.2", "onnx=={}".format(ONNX_VERSION), "tf2onnx==1.9.3"],
    "tensorflow_1.15": ["tensorflow==1.15.0", "pandas==1.4.2", "onnx=={}".format(ONNX_VERSION), "tf2onnx==1.9.3"],
