...
class CloudCacheHelper:
    ...
    def update_model_config(self, cloud_model_path, adapter_path, model_config, input_model_hash, output_model_path):
        ...
        self.download_blob_list(blob_list, model_directory_prefix, output_model_path)
        ...
        self.download_blob_list(blob_list, adapter_directory_prefix, output_model_path, "adapter")
        ...
        if model_config.type.lower() == "hfmodel" and adapter_path:
            model_config.config["adapter_path"] = str(output_model_path / adapter_path)

        return model_config

    def download_blob_list(self, blob_list, directory_prefix, output_model_path, prefix: str = None):
    ...
    def get_path_from_cloud(self, output_model_hash):
    ...
    def get_model_config_by_hash_key(self, output_model_hash: str, output_model_path: Path):
...
def check_model_cache(cloud_cache_helper: CloudCacheHelper, output_model_hash: str, output_model_path: Path):
...
def update_input_model_config(
    cloud_cache_helper: CloudCacheHelper, input_model_config, input_model_hash, output_model_path
):
