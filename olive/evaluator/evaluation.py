...
def evaluate_accuracy(
    model: OliveModel, metric: Metric, device: Device = Device.CPU, execution_providers: Union[str, List[str]] = None
) -> Dict[str, Any]:
    """
    ...
    sess = model.prepare_session(
        inference_settings=model_inference_settings, device=device, execution_providers=execution_providers
    )
...
def evaluate_custom_metric(model: OliveModel, metric: Metric, device: Device = Device.CPU, execution_providers=None):
