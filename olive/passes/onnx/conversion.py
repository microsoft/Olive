...
class OnnxConversion(Pass):
    ...
    def _patch_model_if_necessary(self, pytorch_model: PreTrainedModel):
        ...
        def patched_forward(*args, **kwargs):
            ...
            if (
                ...
                logger.info("Stepping into first if clause")
                ...
                logger.info("Stepping into second if clause")
        ...
        logger.info("PyTorch model patched for transformers v%s.", transformers.__version__)
    ...
    def _convert_model_on_device(
        ...
        self._patch_model_if_necessary(pytorch_model)
