...
class ExtractAdapters(Pass):
    ...
    def _extract_loha_adapter(self, dag: OnnxDAG, config: Dict[str, Any]):
    ...
    def _extract_adapter(self, dag: OnnxDAG, config: Dict[str, Any], adapter_type: AdapterType = AdapterType.LORA):
    ...
    def _process_add_node(
        self, dag: OnnxDAG, node_name: str, weights: Dict[str, Any], new_weight_name: str, float_modules: Set[str]
    ):
    ...
    def _process_initializer(
        self, dag: OnnxDAG, node_name: str, weights: Dict[str, Any], old_input: str, new_input: str
    ):
