...
from quark.onnx import ModelQuantizer, LayerWiseMethod
...
def main(args: argparse.Namespace) -> None:
    ...
    elif args.calib_method == "percentile":
...
if __name__ == "__main__":
    ...
    parser.add_argument("--calibration_dataset_path",
                        ...
                        default='',
                        required=False)
    parser.add_argument("--calib_method", help="The PTQ algorithm selection for quantization", type=str, default="", required=False)
