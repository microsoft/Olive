...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        choices=SUPPORTED_QUANT_SCHEME,
    )
    parser.add_argument(
        "--kv_cache_dtype",
    ...
    parser.add_argument(
        ...
        choices=["rotation", "smoothquant", "quarot"],
        action="append",
        default=[],
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        default=None,
        choices=["awq", "gptq", "autosmoothquant", "quarot", None],
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--moe_experts_second_step_config",
        help="The second step quantization config for MoE experts weights.",
        type=str,
        default=None,
        choices=["w_int4_per_channel_sym"],
    )
    ...
    parser.add_argument(
        "--weight_matrix_merge",
        help="Whether to merge weight matrix when dump llm-specific quantized model",
        action="store_true",
    )
    parser.add_argument(
