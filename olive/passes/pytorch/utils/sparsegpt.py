...
@torch.no_grad()
def catch_layer_inputs(model_adapter, dataloader, device, num_samples=None):
    ...
    additional_input = additional_inputs.get(model_adapter.model_type, [])
