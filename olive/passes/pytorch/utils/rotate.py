...
def fuse_layer_norms(model_wrapper: ModelWrapper):
    ...
    for layer_wrapper in model_wrapper.get_layer_wrappers():
        fuse_ln_linear(layer_wrapper.get_first_layer_norm(False), layer_wrapper.get_attention_inputs(False))
        fuse_ln_linear(layer_wrapper.get_second_layer_norm(False), layer_wrapper.get_mlp_inputs(False))

    # LM Head: Fuse layernorm into linear layer
    fuse_ln_linear(model_wrapper.get_pre_head_layernorm(False), [model_wrapper.get_lm_head(False)])
