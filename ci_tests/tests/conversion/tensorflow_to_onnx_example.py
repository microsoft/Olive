...
def create_and_train_mnist():
    ...
    # return a single record of test data for ONNX validation
    # mnist.test.next_batch(1)[0] stands for input data
    # mnist.test.next_batch(1)[1] stands for ouput label
    return sess, saver, input_tensor, output_tensor, mnist.test.next_batch(1)[0]
