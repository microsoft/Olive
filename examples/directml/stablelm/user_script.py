...
def stablelm_inputs(batch_size, torch_dtype):
...
def stablelm_data_loader(data_dir, batch_size):
    return RandomDataLoader(stablelm_inputs, batch_size, torch.float16)
