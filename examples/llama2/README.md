...
olive export-adapters --adapter_path Mikael110/llama-2-7b-guanaco-qlora --dtype float16 --pack_weights --output_path models/guanaco_fp16_packed.npz
```
...
```bash
olive run --config lamma2_genai.json
```
