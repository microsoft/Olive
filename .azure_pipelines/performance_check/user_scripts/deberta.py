...
def create_dataloader(data_dir, batch_size, *args, **kwargs):
    return get_data_container(
        MODEL_CONFIG["model_name"], MODEL_CONFIG["task"], **MODEL_CONFIG["dataset"]
...
def post_process(result):
    return get_data_container(MODEL_CONFIG["model_name"], MODEL_CONFIG["task"], **MODEL_CONFIG["dataset"]).post_process(
        result
    )
