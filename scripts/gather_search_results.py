...
def scan_evaluations(
    ...
    if not blob_account_url:
        raise ValueError("blob_account_url is required when resolving evaluation results from blob storage")
    ...
    try:
        ...
        raise ImportError(
            "Resolving evaluation results requires the 'azure-identity' and 'azure-storage-blob' packages. "
